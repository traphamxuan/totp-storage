...
export function OtpList() {
    ...
    return (
        <div className="bg-background rounded-lg shadow-md p-6 dark:bg-gray-1000 dark:shadow-gray-700">
            {/* Header row with title, search, and column visibility toggle */}
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold dark:text-white">Public Keys</h2>
                <Search
                    table={table}
            ...
            {(loading && totps.length === 0) ? (
                ...
                <div className="text-center py-8">
                    <p className="text-muted-foreground dark:text-gray-400">No TOTP keys stored yet.</p>
                </div>
            ) : (
